...
// Try VITE_LULUBABY_STRIPE_PUBLISHABLE_KEY (injected from secrets) first
const STRIPE_PUBLISHABLE_KEY = import.meta.env.VITE_LULUBABY_STRIPE_PUBLISHABLE_KEY || import.meta.env.VITE_STRIPE_PUBLISHABLE_KEY || "";
if (!STRIPE_PUBLISHABLE_KEY) {
  console.warn("[Stripe] Stripe publishable key is not set. Payments will not work. Set LULUBABY_STRIPE_PUBLISHABLE_KEY in secrets.");
}
